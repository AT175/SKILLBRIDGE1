...
function AdminPanel() {
  ...
  const suspendUser = (id) => {
    fetch(`${API_BASE_URL}/api/admin/users/${id}/suspend`, { method: 'PATCH' })
  ...
  return (
    <div>
      ...
      <button onClick={() => window.open(`${API_BASE_URL}/api/admin/reports/users`, '_blank')}>Export Users CSV</button>
